...
int main(){
    ...
    //roda até que tenha percorrido todo o vetor de tamanhos
    while(vetorPos <= quantidadeTamanhos - 1){
        ...
        //embaralha a array cda forma que foi pedida.
        menu(Array, ArrayIndex, tamanhoVetor,selecaoVetor);
        //faz uma copia da array embaralhada
        copiar(Array, copia, tamanhoVetor);

        //condicional para saber se o algoritmo foi escolhido ou não para ser rodado.
        if(selecao == 1 || selecao == 0){
            ...
            while (vezes<vezesTotal){
                ...
                //abre um arquivo para escrita. se for a primeira vez que o algoritmo roda para o tamanho atual,
                //apaga o arquivo, se ja existir um, e cria um novo.
                if(vezes == 0){
                ...
                //guarda o tempo dessa execução em uma linha do arquivo
