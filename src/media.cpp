...
int main(){
    ...
    */
    ...
    int vetorPos = 0;
    std::cout << "Escreva a quantidade de tamanhos para o vetor que deseja fazer a media:";
    std::cin >> quantidadeTamanhos;
    int arrayTamanhos[quantidadeTamanhos];
    std::cout << "Escreva quais os valores de tamanhos para o vetor que deseja fazer a media:";
